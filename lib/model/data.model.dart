...
class Stations {
  ...
  Stations({this.oIIE, this.oIIP, this.oIII});

  Stations.fromJson(Map<String, dynamic> json) {
    oIIE = json['OIIE'] != null ? new OIIE.fromJson(json['OIIE']) : null;
    oIIP = json['OIIP'] != null ? new OIIE.fromJson(json['OIIP']) : null;
    oIII = json['OIII'] != null ? new OIIE.fromJson(json['OIII']) : null;
  }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    if (this.oIIE != null) {
      data['OIIE'] = this.oIIE!.toJson();
    }
    if (this.oIIP != null) {
      data['OIIP'] = this.oIIP!.toJson();
    }
    if (this.oIII != null) {
      data['OIII'] = this.oIII!.toJson();
    }
    return data;
  }
}
...
class OIIE {
  ...
  OIIE.fromJson(Map<String, dynamic> json) {
